  ...
  return (
    <>
      <div className="headerWrapper relative">
        <header className="overflow-hidden header h-[120px] flex items-center gap-4 border-b border-white/10 bg-[#0f0f0f] py-4 pe-0 ps-0 lg:ps-4">
          {/* LEFT SECTION */}
        ...
        {/* 🔴 SEARCH DROPDOWN */}
        {searchTerm && (
          <div className="absolute left-0 top-full mt-3 w-full bg-gradient-to-r from-[#0f0f0f] to-[#1a1a1a] p-6 rounded-md shadow-2xl z-[999999]">
